...
export class DataService {
  ...
  GetPeliculas(texto: string): any {
    return this.http.get('https://api.themoviedb.org/3/search/movie?api_key=a336bda54c7428329d1b9f521055fd14&language=es-ES&query='+texto+'&page=1&include_adult=false'+texto);
  }
